...
import { CreateFinancialEntryDTO, FinancialEntryType } from '../dtos';
import { AppError } from '../../../shared/errors/AppError';

export class CreateFinancialEntryService {
  constructor(private financialEntryRepository: IFinancialEntryRepository) {}

  async execute({ companyId, type, amount, description, date, categoryId }: CreateFinancialEntryDTO): Promise<FinancialEntry> {
    if (!companyId) {
