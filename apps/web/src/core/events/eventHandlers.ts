...
export const handleServiceOrderCompleted = async (event: DomainEvent) => {
  ...
  console.log('[Domain Automation] OS Completed detected. Generating Draft Invoice...');
...
export const handleInvoicePaid = async (event: DomainEvent) => {
  ...
  console.log('[Domain Automation] Invoice Paid detected. Emitting Stock Movements...');
